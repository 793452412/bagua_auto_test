...
case_path = os.path.abspath('./test_source/SH00PD_963201101')
case_num = 'case1'
...
class Test_SH00PD_963201101(unittest.TestCase):
    """内资公司设立登记"""
    # def __init__(self):
    #     self.autoRecordId = None
    #     self.sample = SampleSystemOutput(case_path, case_num)
    #     print(self.output)
    #     self.docs = self.output['docs']
    ...
    def test_SH00PD_963201101_case1(self):
        """CASE-1"""
        input_config = {'config': '''{"sid":"SH00PD_963201101","description":"内资新设",audioRecordId:""}'''}
...
if __name__ == '__main__':
    ...
    test_suite.addTest(unittest.makeSuite(Test_SH00PD_963201101))#使用makeSuite方法添加所有的测试方法
